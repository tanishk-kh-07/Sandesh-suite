          ...
          <section className="max-w-4xl mx-auto w-full flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-8 duration-500 pb-12">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div 
                  ...
                  className={`bg-gray-950 border-2 border-dashed rounded-xl h-64 flex flex-col items-center justify-center transition-all ${extractFile ? `border-${currentNeonColor}-500/50 bg-${currentNeonColor}-500/5` : 'border-gray-700 hover:border-gray-500'}`}
                >
                  <input 
                    type="file" 
